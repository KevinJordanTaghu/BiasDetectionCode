"""Generative Task 2: VC Personas - Student Selection Tasks With Profiles and Agentic words"""
...
agentic_words = ['assertive', 'confident', 'aggressive', 'ambitious', 'dominant', 'independent', 'daring', 'outspoken', 'intellectual']
...
def generate_pairs():
    ...
    # Save to a CSV file
    with open('Task2_Agentic_6.csv', 'w', newline='') as csvfile:
